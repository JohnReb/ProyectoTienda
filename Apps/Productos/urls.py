...
from .views import categorias, ViewInfo, nuevoProducto, editarProducto, eliminarProducto, nuevoRegistroCat, editarRegistroCat, eliminarRegistroCat, ViewInfoTienda, carrito, pagar
